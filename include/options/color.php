			...
			'header-color' => array(
				...
				'options' => array(
					...
					'top-bar-bottom-border-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.traveltour-body .traveltour-top-bar{ border-bottom-color: #gdlr#; }'
					),
				...
				'options' => array(
					...
					'button-text-color' => array(
						...
						'selector' => '.gdlr-core-body .gdlr-core-load-more, .gdlr-core-body .gdlr-core-button, .traveltour-body .traveltour-button, ' .
							'.traveltour-body input[type="button"], .traveltour-body input[type="submit"]{ color: #gdlr#; }'
					),
					...
					'button-background-color' => array(
						...
						'default' => '#2F2F2F',
						'selector' => '.gdlr-core-body .gdlr-core-load-more, .gdlr-core-body .gdlr-core-button, .traveltour-body .traveltour-button, ' .
							'.traveltour-body input[type="button"], .traveltour-body input[type="submit"]{ background-color: #gdlr#; }'
					),
