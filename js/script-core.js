...
(function($){
	...
	if ( $('body.single').length ){
		...
		//Plantillas para la tabla
				var tmplwrap ="<div id='tabla-contenido'>\n<div><p class='titulo'>Tabla de Contenido<span class='ez-toc-title-toggleuno' id='showhiddentablecont'><a class='ez-toc-pull-rightuno ez-toc-btnuno ez-toc-btn-xsuno ez-toc-btn-defaultuno'><i class='fa fa-align-justify'></i></a></span></p></div>\n<nav>{contenido}</nav></div>";
		...
		else if($('.entry-content h3').length) {

		    $(cadena).insertBefore($('.entry-content h3').first());

		}
		else if($('.entry-content h4').length) {
		    $(cadena).insertBefore($('.entry-content h4').first());
		}
		else if($('.traveltour-content-area h2').length) {

		    $(cadena).insertBefore($('.traveltour-content-area h2').first());

		}
		else if($('.traveltour-content-area h3').length) {
		    $(cadena).insertBefore($('.traveltour-content-area h3').first());
		}
...
jQuery(document).ready(function(){
  jQuery("#showhiddentablecont").click(function(){
    jQuery("div#tabla-contenido nav").toggle();
  });
});*/